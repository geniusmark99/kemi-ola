<div class="mx-auto bg-white rounded-md border shadow-sm px-2 py-3">
    ...
    <form action="{{ route('admin.courses.upload') }}" x-data="{ isUploading: false }" x-on:submit="isUploading = true"
        ...
        <div>
            <div class="flex flex-col lg:flex-row lg:items-center align-baseline lg:justify-between lg:gap-x-5 w-full">

                <div class="w-full md:w-3/12 flex flex-col gap-y-3">
                ...
                <div class="w-full md:w-3/12 flex flex-col gap-y-2">
                    ...
                    <div class="border-2 w-full border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center"
                        ...
                        <div class="w-full h-40 flex items-center justify-center cursor-pointer relative"
                            ...
                            <p id="thumbnail-placeholder" class="text-gray-500">Drag & drop a thumbnail or click to
                                select</p>
                ...
                <div class="w-full md:w-3/12 flex flex-col gap-y-2">
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center"
                        ...
                        <div class="w-full h-40 flex items-center justify-center cursor-pointer relative"
                            id="video-area">
                            <p id="video-placeholder" class="text-gray-500">Drag & drop a video or click to select</p>
                ...
                <!-- Submit Button -->
                <div class="w-full md:w-3/12 gap-y-3 h-full flex flex-col justify-center ">
                    <div>
